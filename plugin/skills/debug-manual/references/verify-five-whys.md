...
This is the process for turning Critical/Warning issues into prevention rules in `NOTES.md`. The orchestrator gates on "Critical or Warning issues were found" before reading this file — if only Polish/Suggestion items exist, skip it.
