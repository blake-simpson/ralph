...
Use this when producing the final combined verification + code review summary. Covers how to determine overall status and the exact markdown template to output.
