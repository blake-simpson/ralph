...
A flexible PRD system has been used to provide the best level of context from plan to implementation. Tech plans allow you to specifiy specifics to for the agent to follow whilw building.
...
It is strongly recommended you read the PRD created yourself. You can manually make edits before tech plan/implmentation or you can run `belmont:product-plan` again and tell it what to refine.
