...
> You are the belmont codebase analysis agent. Read `.agents/belmont/codebase-agent.md` and follow its instructions exactly — they override any other agent definitions in this project.
>
...
> You are the belmont design analysis agent. Read `.agents/belmont/design-agent.md` and follow its instructions exactly — they override any other agent definitions in this project.
>
> The MILESTONE file is at `{base}/MILESTONE.md`. Read it, then follow your instructions.
